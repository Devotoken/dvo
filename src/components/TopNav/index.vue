<template>
  <nav class="navbar navbar-inverse navbar-fixed-top role=navigation is-transparent" role="navigation" aria-label="main navigation">
    ...
    <div id="" class="navbar-menu" v-bind:class="{'is-active': isOpen}">
